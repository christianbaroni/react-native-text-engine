...
After running the full suite on a platform, update its section in [results.md](results.md) with the date, device, build configuration, and measurements. Keep results from different devices or test versions separate.
