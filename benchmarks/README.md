...
| ----------------------------------------------------------------------- | -------------------------------------------------------------- | ------------------------------------- |
| [TextView and PreparedTextView vs React Native Text](rn-text/README.md) | Native measurement, mount, and first draw on iOS and Android   | [RN comparison](rn-text/results.md)   |
